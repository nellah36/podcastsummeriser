...
def main():
    ...
    if process_button:
        ...
        # Debugging: Print podcast_info to check its structure
        st.write(podcast_info)
        
        # Updated check to handle missing data gracefully
        if not podcast_info.get("podcast_summary") or \
           not podcast_info.get("podcast_highlights"):
